...
function displayImmigrationForm(){
    ...
    immigrationForm.append(terrorRadioYesInput)

    // CREATE 'YES' RADIO LABEL
    let terrorRadioYesInputLabel = document.createElement("label")
    terrorRadioYesInputLabel.setAttribute("for","radio-yes")
    ...
    immigrationForm.append(terrorRadioNoInput)
